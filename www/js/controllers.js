...
.controller('CalendarCtrl', function($scope, $stateParams, $filter, ionicDatePicker, $ionicSlideBoxDelegate) {
...
.controller('CalendarViewCtrl', function($scope, $stateParams, $filter, $ionicPopup, $ionicSlideBoxDelegate) {
